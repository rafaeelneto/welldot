...
<template>
  <div class="landing-bg min-h-screen text-content-0 font-display">
    <!-- Sticky glass nav -->
    ...
    <div class="container-landing flex items-center gap-4 lg:gap-6 py-3">
      <!-- Brand -->
      <NuxtLink to="/" class="flex items-center gap-2.5 font-bold text-base tracking-tight text-content-0 no-underline">
        <div
      ...
      <!-- Desktop primary CTA -->
      <Button label="Abrir editor" size="small" as="a" href="#" class="hidden lg:inline-flex" />
    ...
    <footer class="border-t border-surface-200/60">
      <div class="container-landing py-7 font-mono text-[11px] text-content-500 flex flex-wrap gap-6">
